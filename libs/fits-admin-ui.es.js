import { resolveComponent, openBlock, createBlock, withCtx, createVNode, createTextVNode, getCurrentScope, onScopeDispose, watch, unref, createElementBlock, createElementVNode, warn, getCurrentInstance, computed, ref, inject, onMounted, toRef, onUnmounted, isRef, defineComponent, mergeProps, renderSlot, nextTick, useSlots, resolveDynamicComponent, normalizeClass, withDirectives, vModelCheckbox, Fragment, toDisplayString, createCommentVNode, normalizeStyle, provide, toRefs, Transition, toHandlers, reactive, h, withModifiers, renderList, vShow, shallowRef, onUpdated } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    (_b = (_a2 = getCurrentInstance().attrs) == null ? void 0 : _a2.tree) == null ? void 0 : _b.data;
    ...
    const nodeClick = (node, option, event) => {
      if (option.isLeaf) {
                ...
                return [
                  createElementVNode("div", _hoisted_2, [
                    withDirectives(createVNode(_component_el_input, mergeProps({
                      ...
                      [vShow, _ctx.$attrs.filterInput.show]
                    ]),
                    createVNode(unref(ElTree), mergeProps({
                      ...
                      class: "tree",
                      props: { ...defaultProps, ...(_a3 = _ctx.$attrs.tree) == null ? void 0 : _a3.props }
                    }), null, 16, ["props"])
                  ])
                ];
              }),
...
var TreeSelect = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-29529203"]]);
const FitAdminUI = {
  install: (app) => {
